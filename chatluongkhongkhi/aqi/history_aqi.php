...
<!-- 									<td><a href="history-xoa.php?username=<?php echo $tentaikhoan ?>&tenfile=<?php echo $row[2]; ?>" class="btn" style="coltdor:white;background: red; margin-left:20px">Xóa</a></td>     -->
									<td><a href ="aqi-history-xoa.php">test</a></td>
								</tr>
							</tbody>
							<?php
						}
